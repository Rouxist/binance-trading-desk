...
def retry_gspread(func, max_retries=5):
    """
...
def add_transaction_log(
    ...
    start_col = 2
    col_values = retry_gspread(lambda: worksheet.col_values(start_col))
    ...
    retry_gspread(lambda: worksheet.update([row_element_list], update_range))
